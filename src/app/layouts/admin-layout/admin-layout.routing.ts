...
import { ListNotificationsComponent } from 'app/pages/notificationss/list-notifications/list-notifications.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'notificaciones/lista',      component: ListNotificationsComponent },
