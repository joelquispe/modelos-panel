...
export class NotificationssComponent implements OnInit {
  ...
  async sendNotification(){
    ...
    fetch("https://fcm.googleapis.com/fcm/send",{
      method:"POST",
      headers: new Headers({
        Authorization: "key=AAAAaiMH0qo:APA91bGEzw69rl-FwNCao1lwAc2gfjp5iaiMUF1FdsA7m1kLpY75fKgXbkHPLjUPAY6Z11kpfO6nt8dbEJaY9FLD-cTi2AVq2ke25AB1u5310s1WfiLYxW0C35GFlS_qOkzS9fDoJJpH",
